...
public class EventosDAOTest {
	...
	public void testAdd() throws DAOException {
		final Evento event = this.dao.add("Evento a�adido", 2, 1, "05/05/2015",
				"15/05/2015", "Barcelona", "descripcion corta5",
				"descripcion larga5", "Libros", "Local 5");

		assertEquals("Evento a�adido", event.getTitulo());
		...
		assertEquals("Evento a�adido", eventGet.getTitulo());
	...
	public void testAddNullAsistentes() throws DAOException {
		this.dao.add("Evento a�adido", 2, 0, "05/05/2015", "15/05/2015",
	...
	public void testAddNullFechaInicio() throws DAOException {
		this.dao.add("Evento a�adido", 2, 1, null, "15/05/2015", "Barcelona",
				"descripcion corta5", "descripcion larga5", "Libros", "Local 5");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testAddNullFechaFin() throws DAOException {
		this.dao.add("Evento a�adido", 2, 1, "05/05/2015", null, "Barcelona",
				"descripcion corta5", "descripcion larga5", "Libros", "Local 5");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testAddNullLocalidad() throws DAOException {
		this.dao.add("Evento a�adido", 2, 1, "05/05/2015", "15/05/2015", null,
				"descripcion corta5", "descripcion larga5", "Libros", "Local 5");
	}

	@Test(expected = IllegalArgumentException.class)
	public void testAddNullDescripcionCorta() throws DAOException {
		this.dao.add("Evento a�adido", 2, 1, "05/05/2015", "15/05/2015",
	...
	public void testOrdenarEventos() throws DAOException {
		this.dao.add("Evento a�adido", 2, 5, "05/05/2015", "15/05/2015",
